# 特朗普式主动管理：非雇员在华企业OD管理复盘与实体清单面试改进思考
...
- **商汤科技开发有限公司**
  ...
  - 运营中结果：业务前几个月积极性、技术成果都不错。几个月后，因涉及敏感的人脸识别项目，监管部门需要签署数据安全不外泄的协议。企业觉得无法保证数据完全本地化，因此进行主动管理（OD）。企业在有一定技术优势的基础上，还是希望保持灵活的数据处理模式，因此遇到严格协议要求就选择主动管理（OD）

## 四、处理结果

综上案例数据，9家企业中有5家是主动管理（OD），4家为计划外退场（OD）。
