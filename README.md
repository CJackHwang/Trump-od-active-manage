...
- **海康威视数字技术股份有限公司**
  ...
  - 市场准入复盘：技术审查勉强通过
  - 运营中结果：业务中安排了政府采购类项目，该业务需要大量的合规审查和人权尽职调查。因其在新疆业务的透明度比较差，与国会也不怎么交流。且在国内市场，主要是接收政府被动安排的项目。主动进行人权风险管理意识低。透明度弱，无法满足合规需求，被主动管理（OD）
...
- **科大讯飞股份有限公司**
  ...
  - 运营中结果：实际业务中涉及语音数据处理，有明显的数据安全合规畏难情绪。安排的合规要求不能独立完成。2019年10月被主动管理（OD）
...
- **商汤科技开发有限公司**
  ...
  - 运营中结果：业务前几个月积极性、技术成果都不错。几个月后，因涉及敏感的人脸识别项目，监管部门需要签署数据安全不外泄的协议。企业觉得无法保证数据完全本地化，因此主动管理（OD）。企业在有一定技术优势的基础上，还是希望保持灵活的数据处理模式，因此遇到严格协议要求就选择主动管理（OD）

## 四、处理结果

综上案例数据，9家企业中有5家是主动管理（OD），4家为计划外离职（OD）。

## 五、经验和教训

综合上述数据，对中国科技企业的OD管理数据进行整理，提炼出一些市场准入环节中的重点关注点，需要针对这些特征，在审查环节中加大重点考核。
